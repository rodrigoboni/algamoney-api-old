...
/**
 * Filtro para implementar controle CORS (Cross Origin Resource Sharing)
 * <p>
 * Não foi utilizado o método corsConfigurer do spring devido a este não ter integração com oauth2
 *
 * @author s2it_rboni
 */
@Component
