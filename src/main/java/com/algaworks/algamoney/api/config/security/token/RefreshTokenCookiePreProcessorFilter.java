 ...
 * <p>
 * Ao gerar o refresh_token o mesmo é retirado do response e definido em cookie Neste filtro é feito o processo inverso, a partir do
 * cookie definir conteudo do request p/ o spring ler o refresh_token
 * <p>
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if ("/oauth/token".equalsIgnoreCase(req.getRequestURI()) && "refresh_token".equals(req.getParameter("grant_type")) && req.getCookies() != null) {
			...
			for (Cookie cookie : req.getCookies()) {
				// verificar o nome do cookie e seu conteúdo (qdo for feito logout será definido
				// um cookie vazio com o mesmo nome)
